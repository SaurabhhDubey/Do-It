...
function Register() {
  ...
  const signup = async () => {
    ...
    // Placeholder for registerUser API call
          ...
          <div className="w-full max-w-md mx-auto lg:mx-0 order-1 lg:order-2">
            <div className="backdrop-blur-xl bg-white/70 border border-white/40 rounded-3xl shadow-xl shadow-slate-200/50 p-8 hover:shadow-2xl hover:shadow-slate-200/60 transition-all duration-500">
              ...
              <div className="flex gap-3 mb-5">
                <button className="flex-1 flex items-center justify-center gap-2 py-2.5 px-4 bg-white/80 border border-slate-200/80 rounded-xl hover:bg-white hover:border-slate-300 hover:shadow-md transition-all duration-300 group">
              ...
              <div className="relative mb-5">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-4 bg-white/70 text-slate-500">or register with email</span>
                </div>
              </div>
